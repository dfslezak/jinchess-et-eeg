...
public class JBoard extends JComponent{
  ...
  protected void processMouseEvent(MouseEvent evt){
    ...
    if (evtID == MouseEvent.MOUSE_RELEASED){
        System.out.println("<MouseEvent> " + Long.toString(System.currentTimeMillis()) + "\t" + Integer.toString(evt.getX()) + "\t" + Integer.toString(evt.getY()) + "\t MOUSE RELEASED");
    }
    if (evtID == MouseEvent.MOUSE_PRESSED){
        System.out.println("<MouseEvent> " + Long.toString(System.currentTimeMillis()) + "\t" + Integer.toString(((JComponent)evt.getSource()).getX()+evt.getX()) + "\t" + Integer.toString(((JComponent)evt.getSource()).getY()+evt.getY()) + "\t MOUSE PRESSED");
    }
    ...
    if (square == null){
      if ((evtID == MouseEvent.MOUSE_RELEASED) && isMovingPiece()){
  	    System.out.println("<MouseEvent> " + Long.toString(System.currentTimeMillis()) + "\t" + Integer.toString(evt.getX()) + "\t" + Integer.toString(evt.getY()) + "\t MOVE CANCELLED");
        cancelMovingPiece();
      }
      return;
    }
    ...
    if (isLeftMouseButton && ((evtID == MouseEvent.MOUSE_PRESSED) ||
      ...
      if (movedPieceSquare == null){
        ...
        if (isPieceFollowsCursor())
  	    ...
  	    System.out.println("<MouseEvent> " + Long.toString(System.currentTimeMillis()) + "\t" + Integer.toString(evt.getX()) + "\t" + Integer.toString(evt.getY()) + "\t MOVE MAKING STARTED");
        ...
        movedPieceLoc = null;
  	    ...
  	    System.out.println("<MouseEvent> " + Long.toString(System.currentTimeMillis()) + "\t" + Integer.toString(evt.getX()) + "\t" + Integer.toString(evt.getY()) + "\t MOVE MAKING ENDED");
        fireMoveProgressEvent(new MoveProgressEvent(this, MoveProgressEvent.MOVE_MAKING_ENDED));
      }
    }
  }
  ...
  protected void processMouseMotionEvent(MouseEvent evt){
    ...
    System.out.println("<MouseEvent> " + Long.toString(System.currentTimeMillis()) + "\t" + Integer.toString(evt.getX()) + "\t" + Integer.toString(evt.getY()));
